...
export default class Mesh {
  ...
  bufferData(type: BufferType) {
    switch (type) {
      case BufferType.VERTEX: return this.vertices;
      case BufferType.NORMAL: return this.normals;
      case BufferType.TANGENT: return this.tangents;
      case BufferType.UV: return this.uv;
      case BufferType.UV2: return this.uv2;
      case BufferType.UV3: return this.uv3;
      case BufferType.UV4: return this.uv4;
      case BufferType.UV5: return this.uv5;
      case BufferType.UV6: return this.uv6;
      case BufferType.UV7: return this.uv7;
      case BufferType.UV8: return this.uv8;
      case BufferType.TRIANGLE: return this.triangles;
